/*document.addEventListener('DOMContentLoaded', function () {
    ...
    window.adicionarMensagemAoGraficoTempDaSemana = function(media){
        if (indiceAtualSemana === 0) {
            ...
            myChart2.data.datasets[0].data = Array(24).fill(null);
        ...
        if(indiceAtualSemana === 7){
            ...
            for(var i ; i < temperaturasDaSemana.length; i++){
    ...
    window.adicionarMensagemAoGraficoTempDoAno = function(media){
        if (indiceAtualDoAno === 0) {
            ...
            myChart3.data.datasets[0].data = Array(24).fill(null);

            myChart3.update();;
        }

        var dadosAtuaisSemana = myChart3.data.datasets[0].data;
